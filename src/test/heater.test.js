...
const initial = createGameState(opening([170, 50]));
...
assert.equal(heated.board[0].value, 180);
...
const hundred = applyHeater(createGameState(opening([1000])), 0);
assert.equal(hundred.board[0].value, 1010);
