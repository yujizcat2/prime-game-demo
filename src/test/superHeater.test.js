...
const opening = [2, 5, 10].map((value, index) => ({value, foodType: BASE_FOOD_TYPES[index], boardIndex: index, gameMode: "eightPalace"}));
...
const edge = createGameState([{...opening[0], value: 101}]);
