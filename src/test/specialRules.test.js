...
for(const total of [90,130]){const result=combine({value:60,foodType:T.DRINK},{value:total-60,foodType:T.LAND},T.SPICE).board[2];assert.equal(result.value,total>101?total-100:total);assert.equal(result.foodType,T.SPICE);}
